...
const curtistestappAPI = axios.create({
  baseURL: "https://curtis-test-app-12-131232.botics.co",
...
function modules_two_factor_authentication_enable_2fa_retrieve(payload) {
  return curtistestappAPI.get(`/modules/two-factor-authentication/enable/2fa`)
}
function modules_two_factor_authentication_enable_2fa_create(payload) {
  return curtistestappAPI.post(`/modules/two-factor-authentication/enable/2fa`)
}
function modules_two_factor_authentication_enable_2fa_destroy(payload) {
  return curtistestappAPI.delete(
...
function modules_two_factor_authentication_send_otp_create(payload) {
  return curtistestappAPI.post(`/modules/two-factor-authentication/send/otp`)
}
function modules_two_factor_authentication_verify_otp_create(payload) {
  return curtistestappAPI.post(`/modules/two-factor-authentication/verify/otp`)
}
